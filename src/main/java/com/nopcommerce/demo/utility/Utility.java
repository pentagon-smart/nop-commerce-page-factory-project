...
//***************************** Is Display Methods **********************************************//
    ...
    public void mouseHoverThree(WebElement element, WebElement element1,WebElement element2)
    {
        Actions actions= new Actions(driver);
        actions.moveToElement(element).moveToElement(element1).moveToElement(element2).click().build().perform();
    }
}
